...
def main(seed, load_dataset):
    ...
    if not load_dataset:
        ...
        df_preprocessed = preprocess_dataset(df, save=True, dataset_type="CIC_2017", seed=seed, load=load_dataset)
        print("Dataset Preprocesado")
    else:
        df_preprocessed = preprocess_dataset(pd.DataFrame(), save=True, dataset_type="CIC_2017", seed=seed, load=load_dataset)
        print("Dataset Preprocesado")
