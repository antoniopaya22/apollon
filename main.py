...
df = load_data(
    ["./shared/data/CIC_2017/Friday-WorkingHours-Afternoon-DDos.pcap_ISCX.csv", "./shared/data/CIC_2017/Wednesday-workingHours.pcap_ISCX.csv", "./shared/data/CIC_2017/Tuesday-WorkingHours.pcap_ISCX.csv"])
...
models = train_ids_model(x_train=df_preprocessed.x_train, y_train=df_preprocessed.y_train, x_test=df_preprocessed.x_test,
                         y_test=df_preprocessed.y_test, dataset="CIC_2017", models_type=["NB", "LR", "KNN", "DT", "RF", "SVC", "MLP"], save=True, seed=seed)
